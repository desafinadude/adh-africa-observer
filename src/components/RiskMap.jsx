    ...
    getColor = (amount) => {
        ...
        let scale = self.state.scale;
            ...
            if(amount == null || amount == 'NaN') {
                ...
                return self.state.absScale.getColor(amount > 0 ? amount : 1);
            }
                    ...
                    <Card.Body>
                        ...
                        <MapContainer 
                            ...
                            :
                                <div className="position-absolute fw-bold map-legend" style={{bottom: 0}}>
                                    <div>
                                        <Badge style={{backgroundColor: '#FF5454',top: '-4px'}} className="scale100 chart-scale position-relative">&nbsp;</Badge> &gt; 400 per million
                                    </div>
                                    <div className="my-1">
                                        <Badge style={{backgroundColor: '#FFECEC',top: '-4px'}} className="scale0 chart-scale position-relative">&nbsp;</Badge> &lt; 50 per million
                                    </div>
                                </div>
                            }
